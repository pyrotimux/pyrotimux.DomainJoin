...
#ATTRIBUTE:SafemodeAdministratorPassword_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
#ATTRIBUTE:SafemodeAdministratorPassword_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
#ATTRIBUTE:DatabasePath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DatabasePath = Get-Attr -obj $params -name DatabasePath -failifempty $False -resultobj $result
#ATTRIBUTE:DnsDelegationCredential_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
#ATTRIBUTE:DnsDelegationCredential_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
#ATTRIBUTE:DomainNetbiosName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
#ATTRIBUTE:ParentDomainName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
#ATTRIBUTE:SysvolPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
if ($SafemodeAdministratorPassword_username)
{
$SafemodeAdministratorPassword_securepassword = $SafemodeAdministratorPassword_password | ConvertTo-SecureString -asPlainText -Force
$SafemodeAdministratorPassword = New-Object System.Management.Automation.PSCredential($SafemodeAdministratorPassword_username,$SafemodeAdministratorPassword_securepassword)
}

if ($DnsDelegationCredential_username)
{
$DnsDelegationCredential_securepassword = $DnsDelegationCredential_password | ConvertTo-SecureString -asPlainText -Force
$DnsDelegationCredential = New-Object System.Management.Automation.PSCredential($DnsDelegationCredential_username,$DnsDelegationCredential_securepassword)
}
