...
#ATTRIBUTE:TaskName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TaskName = Get-Attr -obj $params -name TaskName -failifempty $True -resultobj $result
#ATTRIBUTE:Argument;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Argument = Get-Attr -obj $params -name Argument -failifempty $False -resultobj $result
#ATTRIBUTE:AtLogOn;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AtLogOn = Get-Attr -obj $params -name AtLogOn -failifempty $False -resultobj $result
#ATTRIBUTE:AtLogOnUserId;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AtLogOnUserId = Get-Attr -obj $params -name AtLogOnUserId -failifempty $False -resultobj $result
#ATTRIBUTE:AtStartup;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AtStartup = Get-Attr -obj $params -name AtStartup -failifempty $False -resultobj $result
#ATTRIBUTE:Compatibility;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:At,V1,Vista,Win7,Win8
$Compatibility = Get-Attr -obj $params -name Compatibility -failifempty $False -resultobj $result
...
#ATTRIBUTE:Daily;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Daily = Get-Attr -obj $params -name Daily -failifempty $False -resultobj $result
...
#ATTRIBUTE:Disable;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Disable = Get-Attr -obj $params -name Disable -failifempty $False -resultobj $result
#ATTRIBUTE:Execute;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Execute = Get-Attr -obj $params -name Execute -failifempty $False -resultobj $result
#ATTRIBUTE:ExecuteTimeLimitTicks;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExecuteTimeLimitTicks = Get-Attr -obj $params -name ExecuteTimeLimitTicks -failifempty $False -resultobj $result
#ATTRIBUTE:Hidden;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Hidden = Get-Attr -obj $params -name Hidden -failifempty $False -resultobj $result
#ATTRIBUTE:Once;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Once = Get-Attr -obj $params -name Once -failifempty $False -resultobj $result
...
#ATTRIBUTE:RepetitionDurationTimeSpanString;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RepetitionDurationTimeSpanString = Get-Attr -obj $params -name RepetitionDurationTimeSpanString -failifempty $False -resultobj $result
#ATTRIBUTE:RepetitionIntervalTimeSpanString;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RepetitionIntervalTimeSpanString = Get-Attr -obj $params -name RepetitionIntervalTimeSpanString -failifempty $False -resultobj $result
#ATTRIBUTE:Runlevel;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Highest,Limited
$Runlevel = Get-Attr -obj $params -name Runlevel -failifempty $False -resultobj $result
#ATTRIBUTE:ScheduledAt;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ScheduledAt = Get-Attr -obj $params -name ScheduledAt -failifempty $False -resultobj $result
#ATTRIBUTE:TaskPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TaskPath = Get-Attr -obj $params -name TaskPath -failifempty $False -resultobj $result
#ATTRIBUTE:WorkingDirectory;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
If ($Compatibility)
{
    If (('At','V1','Vista','Win7','Win8') -contains $Compatibility ) {
    }
    Else
    {
        Fail-Json $result "Option Compatibility has invalid value $Compatibility. Valid values are 'At','V1','Vista','Win7','Win8'"
    }
}
...
If ($Runlevel)
{
    If (('Highest','Limited') -contains $Runlevel ) {
    }
    Else
    {
        Fail-Json $result "Option Runlevel has invalid value $Runlevel. Valid values are 'Highest','Limited'"
    }
}
