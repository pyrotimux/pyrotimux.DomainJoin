...
#ATTRIBUTE:ValueName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ValueName = Get-Attr -obj $params -name ValueName -failifempty $True -resultobj $result
...
#ATTRIBUTE:Hex;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Hex = Get-Attr -obj $params -name Hex -failifempty $False -resultobj $result
