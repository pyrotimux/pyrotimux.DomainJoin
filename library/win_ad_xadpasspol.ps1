...
#ATTRIBUTE:ComplexityEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ComplexityEnabled = Get-Attr -obj $params -name ComplexityEnabled -failifempty $False -resultobj $result
...
#ATTRIBUTE:LockoutDuration;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LockoutDuration = Get-Attr -obj $params -name LockoutDuration -failifempty $False -resultobj $result
#ATTRIBUTE:LockoutObservationWindow;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LockoutObservationWindow = Get-Attr -obj $params -name LockoutObservationWindow -failifempty $False -resultobj $result
#ATTRIBUTE:LockoutThreshold;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LockoutThreshold = Get-Attr -obj $params -name LockoutThreshold -failifempty $False -resultobj $result
#ATTRIBUTE:MaxPasswordAge;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaxPasswordAge = Get-Attr -obj $params -name MaxPasswordAge -failifempty $False -resultobj $result
#ATTRIBUTE:MinPasswordAge;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MinPasswordAge = Get-Attr -obj $params -name MinPasswordAge -failifempty $False -resultobj $result
#ATTRIBUTE:MinPasswordLength;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MinPasswordLength = Get-Attr -obj $params -name MinPasswordLength -failifempty $False -resultobj $result
#ATTRIBUTE:PasswordHistoryCount;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PasswordHistoryCount = Get-Attr -obj $params -name PasswordHistoryCount -failifempty $False -resultobj $result
...
#ATTRIBUTE:ReversibleEncryptionEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ReversibleEncryptionEnabled = Get-Attr -obj $params -name ReversibleEncryptionEnabled -failifempty $False -resultobj $result
...
$DscResourceName = "xADDomainDefaultPasswordPolicy"
