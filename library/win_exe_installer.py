...
DOCUMENTATION = '''
---
module: win_exe_installer
short_description: Installs and uninstalls Windows EXE files
description:
    - Installs or uninstalls a Windows EXE file that is already located on the
      target server
options:
    path:
        description:
