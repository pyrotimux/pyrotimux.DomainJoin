...
#ATTRIBUTE:Category;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Distribution,Security
...
If ($Category)
{
    If (('Distribution','Security') -contains $Category ) {
    }
    Else
    {
...
If ($GroupScope)
{
    If (('DomainLocal','Global','Universal') -contains $GroupScope ) {
    }
    Else
    {
