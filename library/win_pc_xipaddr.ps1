...
#ATTRIBUTE:PrefixLength;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PrefixLength = Get-Attr -obj $params -name PrefixLength -failifempty $False -resultobj $result
