...
$DomainUserCredential = New-Object System.Management.Automation.PSCredential($DomainUserCredential_username,$DomainUserCredential_securepassword)
}
...
$DscResourceName = "xWaitForADDomain"
