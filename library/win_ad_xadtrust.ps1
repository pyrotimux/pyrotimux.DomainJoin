...
#ATTRIBUTE:SourceDomainName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SourceDomainName = Get-Attr -obj $params -name SourceDomainName -failifempty $True -resultobj $result
#ATTRIBUTE:TargetDomainAdministratorCredential_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TargetDomainAdministratorCredential_username = Get-Attr -obj $params -name TargetDomainAdministratorCredential_username -failifempty $True -resultobj $result
#ATTRIBUTE:TargetDomainAdministratorCredential_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TargetDomainAdministratorCredential_password = Get-Attr -obj $params -name TargetDomainAdministratorCredential_password -failifempty $True -resultobj $result
#ATTRIBUTE:TargetDomainName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TargetDomainName = Get-Attr -obj $params -name TargetDomainName -failifempty $True -resultobj $result
#ATTRIBUTE:TrustDirection;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Bidirectional,Inbound,Outbound
$TrustDirection = Get-Attr -obj $params -name TrustDirection -failifempty $True -resultobj $result
#ATTRIBUTE:TrustType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:External,Forest
$TrustType = Get-Attr -obj $params -name TrustType -failifempty $True -resultobj $result
...
If ($TrustDirection)
{
    If (('Bidirectional','Inbound','Outbound') -contains $TrustDirection ) {
    }
    Else
    {
...
If ($TrustType)
{
    If (('External','Forest') -contains $TrustType ) {
    }
    Else
    {
...
if ($TargetDomainAdministratorCredential_username)
{
$TargetDomainAdministratorCredential_securepassword = $TargetDomainAdministratorCredential_password | ConvertTo-SecureString -asPlainText -Force
$TargetDomainAdministratorCredential = New-Object System.Management.Automation.PSCredential($TargetDomainAdministratorCredential_username,$TargetDomainAdministratorCredential_securepassword)
}
...
$DscResourceName = "xADDomainTrust"
