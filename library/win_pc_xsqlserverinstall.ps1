...
$SourcePathCredential = New-Object System.Management.Automation.PSCredential($SourcePathCredential_username,$SourcePathCredential_securepassword)
}

if ($SqlAdministratorCredential_username)
{
$SqlAdministratorCredential_securepassword = $SqlAdministratorCredential_password | ConvertTo-SecureString -asPlainText -Force
$SqlAdministratorCredential = New-Object System.Management.Automation.PSCredential($SqlAdministratorCredential_username,$SqlAdministratorCredential_securepassword)
}

$DscResourceName = "xSQLServerInstall"
